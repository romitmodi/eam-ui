...
import '../index.css'
import dat from '../data/TicketsToApprove.json'
...
export default function SelAndApproveTickets2(): any {
  ...
  const columns = React.useMemo<ColumnDef<Ticket>[]>(
    () => [
      ...
      {
        header: 'Active Tickets of ' + dat.EmpName,
        ...
        columns: [
          ...
          {
            accessorKey: 'Reportee',
            header: 'Reportee Name',
            cell: info => info.getValue(),
            footer: props => props.column.id,
          },
          {
            accessorKey: 'ReporteeID',
            header: 'Reportee ID',
            footer: props => props.column.id,
          },
          {
  ...
  const [data, setData] = React.useState(() => dat.Tickets)
  const refreshData = () => setData(() => dat.Tickets)
